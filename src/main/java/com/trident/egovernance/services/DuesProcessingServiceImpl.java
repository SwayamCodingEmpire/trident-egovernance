...
@Service
public class DuesProcessingServiceImpl implements DuesProcessingService {
    ...
    private final Logger logger = LoggerFactory.getLogger(DuesProcessingServiceImpl.class);

    public DuesProcessingServiceImpl(DuesDetailsRepository duesDetailsRepository, SessionsRepository sessionsRepository, MasterTableServices masterTableServicesImpl) {
